...
### Our model overview
Details about the model is written on our paper.
https://openreview.net/forum?id=HJgTHnActQ
...
##### Train
> Import run.py file from the jupyter notebook. (Example is example.ipynb)
